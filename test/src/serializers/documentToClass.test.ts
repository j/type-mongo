...
test('classToDocument() with @EmbedOne()', async t => {
  @EmbeddedDocument()
  class Address {
...
test('classToDocument() with @EmbedMany()', async t => {
  @EmbeddedDocument()
  class Address {
    @Field() public city: string;
    @Field() public zip: number;
...
test('classToDocument() with @EmbedMany() as object', async t => {
  @EmbeddedDocument()
  class Address {
    @Field() public city: string;
    @Field() public zip: number;
...
test('classToDocument() with @EmbedMany() as map', async t => {
  @EmbeddedDocument()
  class Address {
    @Field() public city: string;
    @Field() public zip: number;
...
test('classToDocument() errors when @EmbedOne() has an unmapped type', async t => {
  class Address {
    @Field() public city: string;
    @Field() public zip: number;
  }
  ...
  t.is(error.message, 'Class "Address" is not a mapped @EmbeddedDocument().');
});

test('classToDocument() with @EmbedOne() as a discriminator type', async t => {
...
test('classToDocument() with @EmbedMany() as a discriminator type', async t => {
  abstract class Animal {
    public abstract type: string;
